...
;; BST -> Number
;; consumes BST, produces sum of all the keys

(check-expect (sum-of-keys BST0) 0)
(check-expect (sum-of-keys BST1) 1)
(check-expect (sum-of-keys BST4) 11)            ; goes to right
(check-expect (sum-of-keys BST3) 15)             ; goes to right and left
(check-expect (sum-of-keys BST42) (+ 42 27 14)) ; goes to left
