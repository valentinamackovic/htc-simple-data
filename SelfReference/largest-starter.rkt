...
;; LisrOfNumber -> Number
;; concumes ListOfNumber produces the largest number, if the list is empty produces 0

(check-expect (largest? empty) 0)
(check-expect (largest? (cons 4 empty)) 4)
(check-expect (largest? (cons 6 (cons 10 (cons 3 empty)))) 10)
